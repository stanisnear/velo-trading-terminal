...
import {VeloPerpsV3_1} from "../src/VeloPerpsV3_1.sol";
import {IPythV2} from "../src/interfaces/IPythV2.sol";
...
contract DeployVeloPerpsV3_1 is Script {
    ...
    function run() external {
        ...
        VeloPerpsV3_1 perps = new VeloPerpsV3_1(
            IERC20(MUSDC_BASE_SEPOLIA),
            IPythV2(PYTH_BASE_SEPOLIA),
            deployer
        );
        ...
        console2.log("");
        console2.log("Next:");
        console2.log("1) Transfer mUSDC liquidity to the new contract");
        console2.log("2) Set VITE_VELO_PERPS_V3_ADDRESS=<new address> in frontend .env");
        console2.log("3) Redeploy frontend");
    }
}
