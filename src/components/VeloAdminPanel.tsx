  ...
  return (
    <div className="velo-admin-wrap" style={{ maxWidth: 1100, margin: '0 auto', padding: 24, overflowX: 'hidden' }}>
      ...
      <div style={{ marginBottom: 24 }}>
        {gaStatsLoading ? (
          <div style={{ padding: 16, borderRadius: 14, background: 'var(--glass-bg)', border: '1px solid var(--glass-border)', backdropFilter: 'blur(24px) saturate(1.8)', WebkitBackdropFilter: 'blur(24px) saturate(1.8)', boxShadow: 'var(--glass-shadow)', ...S.label, color: 'var(--fg-subtle)' }}>
      ...
      <div style={{
        ...
        background: 'var(--glass-bg)', border: '1px solid var(--glass-border)', backdropFilter: 'blur(24px) saturate(1.8)', WebkitBackdropFilter: 'blur(24px) saturate(1.8)', boxShadow: 'var(--glass-shadow)',
